    ...
    return (
        <div>
            ...
            <div className="flex flex-col space-y-8 mt-10 text-white">
                ...
                <button className="border border-blue-500 bg-blue-500 rounded-lg py-3 font-semibold" onClick={() => createUserWithEmailAndPassword(props.auth, email, password).then(history.push('/'))}>Register</button>
            </div>
            </div>
            </div>
        </div>
